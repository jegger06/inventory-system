...
if ($success == 0) {
	$data = array('success' => $success, 'result' => $err_message, 'query' => $sql_total, 'total_users' => $total_users);
} else {
	$data = array('success' => $success, 'result' => $result, 'query' => $sql_total, 'total_users' => $total_users);
}
